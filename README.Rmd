...
but we can also provide an `Ark` ourselvels, to keep track of the pseudonyms 
that have been used and make sure the same key always gets assigned the same 
pseudonym:
...
There are also packages for anonymizing personal identifiable information in 
data sets. If you need watertight anonymization you should check out these 
packages:
